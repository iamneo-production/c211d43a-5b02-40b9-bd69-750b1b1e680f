...
public class SecurityConfig {
	...
	public static final String[] ENDPOINTS_WHITELIST = { "/users/login", "/users/new", "/users/welcome","/candidate/getalluser","/admins","/trainee","/admins/{adminId}","/notes","/notes/{notesId}", "/UserSettings/{userId}", "/InstructorSettings/{userId}" };
