    ...
    <div className="container" >
      ...
      <nav className="LandingNavbar" data-LandingNavbar>
        ...
        <ul className="LandingNavbar-list">
          ...
          <li>
            <Link to="/Home" className="LandingNavbar-link">Home</Link>
           
          </li>

          <li>
            <Link to='/Aboutus' className="LandingNavbar-link">About</Link>
          </li>

          <li>
          <Link to='/Courses' className="LandingNavbar-link">Courses</Link>
          </li>

          <li>
            <Link to="/Instructor" className="LandingNavbar-link">Teachers</Link>
          </li>
          <li>
            <Link to="/Contact" className="LandingNavbar-link">Contact</Link>
          </li>

        </ul>

        <button className="btn btn-secondary" onClick={handleclick}>Get Started</button>
